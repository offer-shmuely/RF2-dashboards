...
local RFSensors3 = {
    ...
    { id=1,   sid=0x1001, name="BEAT",    unit=UNIT_RAW,                 prec=0,    dec=decU16  },
    { id=2,   sid=nil,    name="BATTERY", unit=nil,                      prec=0,    dec=nil     },      -- not used
    -- Main battery voltage
    { id=3,   sid=0x1011, name="Vbat",    unit=UNIT_VOLTS,               prec=2,    dec=decU16  },
    -- Main battery current
    { id=4,   sid=0x1012, name="Curr",    unit=UNIT_AMPS,                prec=2,    dec=decU16  },
    -- Main battery used capacity
    { id=5,   sid=0x1013, name="Capa",    unit=UNIT_MAH,                 prec=0,    dec=decU16  },
    -- Main battery charge / fuel level
    { id=6,   sid=0x1014, name="Bat%",    unit=UNIT_PERCENT,             prec=0,    dec=decU8   },

    -- Main battery cell count
    { id=7,   sid=0x1020, name="Cel#",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    -- Main battery cell voltage (minimum/average)
    { id=8,   sid=0x1021, name="Vcel",    unit=UNIT_VOLTS,               prec=2,    dec=decCellV },
    -- Main battery cell voltages
    { id=9,   sid=0x102F, name="Cels",    unit=UNIT_VOLTS,               prec=2,    dec=decCells },

    -- Control Combined (hires)
    { id=10,  sid=0x1030, name="Ctrl",    unit=UNIT_RAW,                 prec=0,    dec=decControl },
    -- Pitch Control angle
    { id=11,  sid=0x1031, name="CPtc",    unit=UNIT_DEGREE,              prec=1,    dec=decS16  },
    -- Roll Control angle
    { id=12,  sid=0x1032, name="CRol",    unit=UNIT_DEGREE,              prec=1,    dec=decS16  },
    -- Yaw Control angle
    { id=13,  sid=0x1033, name="CYaw",    unit=UNIT_DEGREE,              prec=1,    dec=decS16  },
    -- Collective Control angle
    { id=14,  sid=0x1034, name="CCol",    unit=UNIT_DEGREE,              prec=1,    dec=decS16  },
    -- Throttle output %
    { id=15,  sid=0x1035, name="Thr",     unit=UNIT_PERCENT,             prec=0,    dec=decS8   },
    { id=16,  sid=nil,    name="ESC1_DATA", unit=nil,                    prec=2,    dec=nil     },      -- not used
    -- ESC#1 voltage
    { id=17,  sid=0x1041, name="EscV",    unit=UNIT_VOLTS,               prec=2,    dec=decU16  },
    -- ESC#1 current
    { id=18,  sid=0x1042, name="EscI",    unit=UNIT_AMPS,                prec=2,    dec=decU16  },
    -- ESC#1 capacity/consumption
    { id=19,  sid=0x1043, name="EscC",    unit=UNIT_MAH,                 prec=0,    dec=decU16  },
    -- ESC#1 eRPM
    { id=20,  sid=0x1044, name="EscR",    unit=UNIT_RPMS,                prec=0,    dec=decU24  },
    -- ESC#1 PWM/Power
    { id=21,  sid=0x1045, name="EscP",    unit=UNIT_PERCENT,             prec=1,    dec=decU16  },
    -- ESC#1 throttle
    { id=22,  sid=0x1046, name="Esc%",    unit=UNIT_PERCENT,             prec=1,    dec=decU16  },
    -- ESC#1 temperature
    { id=23,  sid=0x1047, name="EscT",    unit=UNIT_CELSIUS,             prec=0,    dec=decU8   },
    -- ESC#1 / BEC temperature
    { id=24,  sid=0x1048, name="BecT",    unit=UNIT_CELSIUS,             prec=0,    dec=decU8   },
    -- ESC#1 / BEC voltage
    { id=25,  sid=0x1049, name="BecV",    unit=UNIT_VOLTS,               prec=2,    dec=decU16  },
    -- ESC#1 / BEC current
    { id=26,  sid=0x104A, name="BecI",    unit=UNIT_AMPS,                prec=2,    dec=decU16  },
    -- ESC#1 Status Flags
    { id=27,  sid=0x104E, name="EscF",    unit=UNIT_RAW,                 prec=0,    dec=decU32  },
    -- ESC#1 Model Id
    { id=28,  sid=0x104F, name="Esc#",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    { id=29,  sid=nil,    name="ESC2_DATA", unit=nil,                    prec=2,    dec=nil     },      -- not used
    -- ESC#2 voltage
    { id=30,  sid=0x1051, name="Es2V",    unit=UNIT_VOLTS,               prec=2,    dec=decU16  },
    -- ESC#2 current
    { id=31,  sid=0x1052, name="Es2I",    unit=UNIT_AMPS,                prec=2,    dec=decU16  },
    -- ESC#2 capacity/consumption
    { id=32,  sid=0x1053, name="Es2C",    unit=UNIT_MAH,                 prec=0,    dec=decU16  },
    -- ESC#2 eRPM
    { id=33,  sid=0x1054, name="Es2R",    unit=UNIT_RPMS,                prec=0,    dec=decU24  },
    ...
    -- ESC#2 temperature
    { id=36,  sid=0x1057, name="Es2T",    unit=UNIT_CELSIUS,             prec=0,    dec=nil     },
    ...
    -- ESC#2 Model Id
    { id=41,  sid=0x105F, name="Es2#",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },

    -- Combined ESC voltage
    { id=42,  sid=0x1080, name="Vesc",    unit=UNIT_VOLTS,               prec=2,    dec=decU16  },
    -- BEC voltage
    { id=43,  sid=0x1081, name="Vbec",    unit=UNIT_VOLTS,               prec=2,    dec=decU16  },
    -- BUS voltage
    { id=44,  sid=0x1082, name="Vbus",    unit=UNIT_VOLTS,               prec=2,    dec=decU16  },
    -- MCU voltage
    { id=45,  sid=0x1083, name="Vmcu",    unit=UNIT_VOLTS,               prec=2,    dec=decU16  },

    -- Combined ESC current
    { id=46,  sid=0x1090, name="Iesc",    unit=UNIT_AMPS,                prec=2,    dec=decU16  },
    -- BEC current
    { id=47,  sid=0x1091, name="Ibec",    unit=UNIT_AMPS,                prec=2,    dec=decU16  },
    -- BUS current
    { id=48,  sid=0x1092, name="Ibus",    unit=UNIT_AMPS,                prec=2,    dec=decU16  },
    -- MCU current
    { id=49,  sid=0x1093, name="Imcu",    unit=UNIT_AMPS,                prec=2,    dec=decU16  },

    -- Combined ESC temeperature
    { id=50,  sid=0x10A0, name="Tesc",    unit=UNIT_CELSIUS,             prec=0,    dec=decU8   },
    -- BEC temperature
    { id=51,  sid=0x10A1, name="Tbec",    unit=UNIT_CELSIUS,             prec=0,    dec=decU8   },
    -- MCU temperature
    { id=52,  sid=0x10A3, name="Tmcu",    unit=UNIT_CELSIUS,             prec=0,    dec=decU8   },
    ...
    { id=57,  sid=0x10B1, name="Hdg",     unit=UNIT_DEGREE,              prec=1,    dec=decS16  },
    -- Altitude (combined baro+GPS)
    { id=58,  sid=0x10B2, name="Alt",     unit=UNIT_METERS,              prec=2,    dec=decS24  },
    -- Variometer (combined baro+GPS)
    { id=59,  sid=0x10B3, name="Var",     unit=UNIT_METERS_PER_SECOND,   prec=2,    dec=decS16  },

    -- Headspeed
    { id=60,  sid=0x10C0, name="Hspd",    unit=UNIT_RPMS,                prec=0,    dec=decU16  },
    -- Tailspeed
    { id=61,  sid=0x10C1, name="Tspd",    unit=UNIT_RPMS,                prec=0,    dec=decU16  },
    ...
    { id=64,  sid=0x1100, name="Attd",    unit=UNIT_DEGREE,              prec=1,    dec=decAttitude },
    -- Attitude pitch
    { id=65,  sid=0x1101, name="Ptch",    unit=UNIT_DEGREE,              prec=0,    dec=decS16  },
    -- Attitude roll
    { id=66,  sid=0x1102, name="Roll",    unit=UNIT_DEGREE,              prec=0,    dec=decS16  },
    -- Attitude yaw
    { id=67,  sid=0x1103, name="Yaw",     unit=UNIT_DEGREE,              prec=0,    dec=decS16  },

    -- Acceleration (hires combined)
    { id=68,  sid=0x1110, name="Accl",    unit=UNIT_G,                   prec=2,    dec=decAccel },
    -- Acceleration X
    { id=69,  sid=0x1111, name="AccX",    unit=UNIT_G,                   prec=1,    dec=decS16  },
    -- Acceleration Y
    { id=70,  sid=0x1112, name="AccY",    unit=UNIT_G,                   prec=1,    dec=decS16  },
    -- Acceleration Z
    { id=71,  sid=0x1113, name="AccZ",    unit=UNIT_G,                   prec=1,    dec=decS16  },
    { id=72,  sid=nil,    name="GPS",     unit=nil,                      prec=0,    dec=nil  },         -- not used
    -- GPS Satellite count
    { id=73,  sid=0x1121, name="Sats",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    -- GPS PDOP
    { id=74,  sid=0x1122, name="PDOP",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    -- GPS HDOP
    { id=75,  sid=0x1123, name="HDOP",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    -- GPS VDOP
    { id=76,  sid=0x1124, name="VDOP",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    -- GPS Coordinates
    { id=77,  sid=0x1125, name="GPS",     unit=UNIT_RAW,                 prec=0,    dec=decLatLong },
    -- GPS altitude
    { id=78,  sid=0x1126, name="GAlt",    unit=UNIT_METERS,              prec=1,    dec=decS16  },
    -- GPS heading
    { id=79,  sid=0x1127, name="GHdg",    unit=UNIT_DEGREE,              prec=1,    dec=decS16  },
    -- GPS ground speed
    { id=80,  sid=0x1128, name="GSpd",    unit=UNIT_METERS_PER_SECOND,   prec=2,    dec=decU16  },
    -- GPS home distance
    { id=81,  sid=0x1129, name="GDis",    unit=UNIT_METERS,              prec=1,    dec=decU16  },
    -- GPS home direction
    { id=82,  sid=0x112A, name="GDir",    unit=UNIT_METERS,              prec=1,    dec=decU16  },
    ...
    -- CPU load
    { id=85,  sid=0x1141, name="CPU%",    unit=UNIT_PERCENT,             prec=0,    dec=decU8   },
    -- System load
    { id=86,  sid=0x1142, name="SYS%",    unit=UNIT_PERCENT,             prec=0,    dec=decU8   },
    -- Realtime CPU load
    { id=87,  sid=0x1143, name="RT%",     unit=UNIT_PERCENT,             prec=0,    dec=decU8   },

    -- Model ID
    { id=88,  sid=0x1200, name="MDL#",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    -- Flight mode flags
    { id=89,  sid=0x1201, name="Mode",    unit=UNIT_RAW,                 prec=0,    dec=decU16  },
    -- Arming flags
    { id=90,  sid=0x1202, name="ARM",     unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    -- Arming disable flags
    { id=91,  sid=0x1203, name="ARMD",    unit=UNIT_RAW,                 prec=0,    dec=decU32  },
    -- Rescue state
    { id=92,  sid=0x1204, name="Resc",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    -- Governor state
    { id=93,  sid=0x1205, name="Gov",     unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    { id=94,  sid=nil,    name="GOVERNOR_FLAGS", unit=nil,               prec=0,    dec=nil     },      -- not used
    -- Current PID profile
    { id=95,  sid=0x1211, name="PID#",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    -- Current Rate profile
    { id=96,  sid=0x1212, name="RTE#",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },
    { id=97,  sid=nil,    name="BATTERY_PROFILE", unit=nil,              prec=0,    dec=nil     },      -- not used
    -- Current LED profile
    { id=98,  sid=0x1213, name="LED#",    unit=UNIT_RAW,                 prec=0,    dec=decU8   },

    -- Adjustment function
    { id=99,  sid=0x1220, name="ADJ",     unit=UNIT_RAW,                 prec=0,    dec=decAdjFunc },
...
local function isSensorDefined(sensorName)
    -- EdgeTX
    local sensorsDiscovered = getFieldInfo(sensorName) ~= nil
